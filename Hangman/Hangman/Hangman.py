...
# Print UI
def print_ui(censored_word, correct_characters, incorrect_characters, incorrect_words, message):
    # Clear terminal
    os.system('cls||clear')
    # Print game title
    print("HANGMAN")
    ...
    print(hangman[len(incorrect_characters) + len(incorrect_words)])
    print("")
    # Print the number of guesses ramining before the game is lost
    print("Guesses remaining: " + str(6 - (len(incorrect_characters) + len(incorrect_words))))
    print("")
    ...
    print("Correctly guessed letters: " + ', '.join(correct_characters))
    print("Incorrectly guessed letters: " + ', '.join(incorrect_characters))
    print("Incorrectly guessed words: " + ', '.join(incorrect_words))
    print("")
    print("Input one letter to guess! Input the word to solve!")
    print("")
...
def guessing_game(word_list):
    ...
    # Print game UI
    print_ui(censor_word(word, correct_characters), correct_characters, incorrect_characters, incorrect_words, message)
    ...
    while not game_over:
        ...
        if len(incorrect_characters) + len(incorrect_words) >= 6:
            game_over = True
